const colorBuzo = document.getElementById("colorBuzo");
    ...
    const opcionesPorColorBuzo = {
        "azulMarino": ["blanco", "amarillo", "rojo", "arena"],
        "blanco": ["negro", "amarillo", "celeste", "rojo", "naranja", "verde", "azulMarino"],
        "negro": ["blanco", "amarillo", "celeste", "rojo", "naranja", "verde", "arena"],
        "rojo": ["blanco", "azulMarino", "celeste", "negro", "arena"],
        "naranja": ["blanco", "azulMarino", "celeste", "negro", "arena"]
};
