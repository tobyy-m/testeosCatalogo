...
function actualizarImagen() {
    ...
    const basePath = `../../imagenes/remeras/love/love_${remera}_${estampa}`;
    cargarImagen(imgFront, basePath, "front");
    cargarImagen(imgBack, basePath, "back");
}

const opcionesPorColorRemera = {
  "blanco": ["amarillo", "verde", "celeste", "rojo", "negro", "azul", "naranja", "violeta", "pistacho", "rosa"],
  "negro": ["arena", "amarillo", "verde", "celeste", "rojo", "blanco", "azul", "naranja", "pistacho", "rosa"],
  "celeste": ["arena", "rojo", "blanco", "negro", "pistacho"]
};
