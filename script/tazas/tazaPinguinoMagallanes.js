...
const tazaImg       = document.getElementById("tazaPinguinoMagallanes");      // única imagen
...
function actualizarImagen() {
  ...
  const url    = `../../imagenes/tazas/pinguinoMagallanes/tazaPinguinoMagallanes_${modelo}.webp`;
